...
public class ThreeSum {
    ...
    public static List<List<Integer>> solution4(int[] nums) {
        ...
        List<List<Integer>> combinations = CollectionUtil.combineRemoveDup(ArrayUtil.toList(nums), 3);
    ...
    public static Set<int[]> twoSum(int[] nums, int target) {
    ...
    // change to two sum. what? 312 / 313 test cases passed, still Time Limit Exceeded
    ...
    public static List<List<Integer>> solution8(int[] nums) {
        ...
        int countZero = 0;
        HashSet<Integer> set2 = new HashSet<Integer>(); // 存放无重复的元素
        HashSet<Integer> set3 = new HashSet<Integer>(); // 与set2中重复的元素
        for (int i = 0; i < nums.length; i++) {
        ...
        List<Integer> list2 = new ArrayList<Integer>(); //nums 优化后的list
        list2.addAll(set2);
        list2.addAll(set3);
        nums = list2.stream().mapToInt(Integer::intValue).toArray();
        for (int i = 0; i < nums.length; i++) {
            int target = 0 - nums[i];
            Set<Integer> set1 = new HashSet<Integer>();
            for (int j = i+1; j < nums.length; j++) {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(ThreeSum.solution4(nums));
